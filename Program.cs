...
namespace MMWD_CS
{
    static class Program
    {
        ...
        public static int cadence = 4,s=10;
        ...
        public static double Function(List<Food> Solution, double BMR)
        {
            ...
            double MaxCalories = BMR + 300, MaxCarbo = 0.2 * MaxCalories, MaxFats = 0.25 * MaxCalories, MaxProteins = 0.3 * MaxCalories;
            double MinCalories = BMR - 300, MinCarbo = 0.1 * MinCalories, MinFats = 0.15 * MinCalories, MinProteins = 0.2 * MinCalories;
            double  wsp2 = 1.5, wsp_edi = 0.1;
            for (int i = 0; i < n; i++)
            {
            ...
            if (SumOfCalories > MaxCalories) Penalty = Penalty + wsp2*(SumOfCalories - MaxCalories);
            if (SumOfCalories < MinCalories) Penalty = Penalty + wsp2*(MinCalories - SumOfCalories);
        ...
        public static List<Food> SetSolution(int n)
        {
            ...
            Solution.Add(Produkty[82]);//Pieczarki, Kalafior, Awokado, Kefir, Sałata, Wafle, Papryka, Maliny
            Solution.Add(Produkty[67]);
            Solution.Add(Produkty[21]);
            Solution.Add(Produkty[73]);
            Solution.Add(Produkty[90]);
            Solution.Add(Produkty[50]);
            Solution.Add(Produkty[80]);
            Solution.Add(Produkty[9]);
            Solution.Add(Produkty[81]);//Pasztet, Marchewki, Sok, Nektarynki, Kasza gryczana, Ryż brąz, Cytryna,Sok
            Solution.Add(Produkty[17]);
            Solution.Add(Produkty[18]);
            Solution.Add(Produkty[53]);
            Solution.Add(Produkty[70]);
            Solution.Add(Produkty[89]);
            Solution.Add(Produkty[31]);
            Solution.Add(Produkty[53]); 
            Solution.Add(Produkty[0]);//Actimel, Maliny, Czekolada, Cielęcina, Agrest, Brokuły, Arbuz, Bakłażan
            Solution.Add(Produkty[1]);
            Solution.Add(Produkty[3]);
            Solution.Add(Produkty[5]);
            Solution.Add(Produkty[6]);
            Solution.Add(Produkty[7]);
            Solution.Add(Produkty[8]);
            Solution.Add(Produkty[9]);
            Global_Solution.AddRange(Solution);*/
